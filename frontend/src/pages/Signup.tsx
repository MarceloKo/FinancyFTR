...
import { Loader2, User, Mail, Lock, Eye, EyeOff, LogIn } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f9fa] p-4">
      ...
      <Card className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold text-[#111827] mb-2">Criar conta</h1>
          <p className="text-sm text-[#6b7280]">Comece a controlar suas finanças ainda hoje</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-[#6b7280] mt-1">A senha deve ter no mínimo 8 caracteres</p>
          </div>
